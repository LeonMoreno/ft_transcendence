...
function createDom(fiber) {
  // If the type is a function component, then run the function to get the rendered element
...
function commitRoot() {
  ...
  wipRoot = null;
  // tem
  deletions = []; // Make sure to reset deletions array after each commit
...
function render(element, container) {
  ...
  // Assuming 'element' is a component, it should return a valid element when called
